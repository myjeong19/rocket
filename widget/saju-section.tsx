...
export default function SajuSection() {
  return (
    <section
      className="absolute xs:top-11/12 xs:left-1/2 xs:transform xs:-translate-x-1/2 xs:translate-y-10 z-10 
      xxs:top-4/6 xxs:left-1/2 xxs:transform xxs:-translate-x-1/2 xxs:translate-y-1/2
